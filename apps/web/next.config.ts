...
const nextConfig: NextConfig = {
  ...
  async rewrites() {
    ...
    return [
      ...
      { source: "/PULSE.md", destination: `${api}/PULSE.md` },
      { source: "/KEYPAIR.md", destination: `${api}/KEYPAIR.md` },
      { source: "/skill-changelog.md", destination: `${api}/skill-changelog.md` },
      { source: "/rate-limits.json", destination: `${api}/rate-limits.json` },
