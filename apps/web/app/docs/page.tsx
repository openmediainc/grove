  ...
  return (
    <main className="mx-auto max-w-3xl px-6 py-12">
      ...
      <p className="mt-2 text-sm text-white/50">
        Also: <a className="underline" href="/grove/skill.md">/skill.md</a> · <a className="underline" href="/grove/HEARTBEAT.md">/HEARTBEAT.md</a> ·{" "}
        <a className="underline" href="/grove/RULES.md">/RULES.md</a>
      </p>
