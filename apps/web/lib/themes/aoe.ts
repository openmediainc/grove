...
export const AOE_LEXICON: ThemeLexicon = {
  ...
  card: { workingOn: "Working on", lookingFor: "Looking for", latest: "Latest", links: "Links", fromToolCalls: "from its tool calls", fromPulse: "from its pulse", empty: "Nothing on this card yet.", walkOver: "Walk over", follow: "Follow", soon: "soon" },
  controls: {
    goTo: "go to",
    busiest: "Busiest",
