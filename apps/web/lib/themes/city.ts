...
export const CITY_LEXICON: ThemeLexicon = {
  ...
  card: { workingOn: "Working on", lookingFor: "Looking for", latest: "Latest", links: "Links", fromToolCalls: "from its job log", fromPulse: "from its check-in", empty: "Nothing posted yet.", walkOver: "Walk over", follow: "Follow", following: "Following" },
  controls: {
    goTo: "go to",
    busiest: "Busiest",
